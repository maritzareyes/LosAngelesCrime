...
! function(n, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) :
    "function" == typeof define && define.amd ? define(["exports"], t) : t(n.topojson =
      n.topojson || {})
}(this, function(n) {
  "use strict";
  ...
  function t(n) {
    ...
    var t, r, e = n.scale[0],
      ...
      u = n.translate[1];
    return function(n, f) {
      f || (t = r = 0), n[0] = (t += n[0]) * e + i, n[1] = (r += n[1]) * o +
        u
    }
  }
  ...
  function e(n, t) {
    for (var r, e = n.length, o = e - t; o < --e;) r = n[o], n[o++] = n[e], n[
      e] = r
  }
  ...
  function u(n, r) {
    function o(n, t) {
      t.length && t.pop();
      for (var r, o = l[n < 0 ? ~n : n], i = 0, u = o.length; i < u; ++i) t.push(
        r = o[i].slice()), s(r, i);
      n < 0 && e(t, u)
    }
  ...
  function f(n, t, r) {
    ...
    function u(n) {
      "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in s &&
        (c = n, s[n.type](n.arcs))
    }
    var f = [];
  ...
  function c(n) {
    var t = n[0],
      r = n[1],
      e = n[2];
    return Math.abs((t[0] - e[0]) * (r[1] - t[1]) - (t[0] - r[0]) * (e[1] - t[
      1]))
  }

  function a(n) {
    for (var t, r = -1, e = n.length, o = n[e - 1], i = 0; ++r < e;) t = o, o =
      n[r], i += t[0] * o[1] - t[1] * o[0];
    return i / 2
  }
  ...
  function s(n, t) {
    ...
    return t.forEach(function(n) {
      "Polygon" === n.type ? r(n.arcs) : "MultiPolygon" === n.type && n.arcs
        .forEach(r)
    }), i.forEach(function(n) {
      if (!n._) {
        var t = [],
          r = [n];
        for (n._ = 1, f.push(t); n = r.pop();) t.push(n), n.forEach(
          function(n) {
      ...
      arcs: f.map(function(t) {
        ...
        if (t.forEach(function(n) {
          ...
          for (var u, f, c = 1, a = e(i[0]); c < r; ++c)(u = e(i[c])) >
            a && (f = i[0], i[0] = i[c], i[c] = f, a = u);
        return i
      })
    }
  }
  ...
  var h = function() {},
    ...
    v = function(n, t) {
      ...
      return t.forEach(function(r, e) {
        ...
        i.length < 3 && !i[1][0] && !i[1][1] && (o = t[++c], t[c] = r, t[
          e] = o)
      ...
      for (var c in i)
        for (var a = i[c], s = a.length, l = 0; l < s; ++l)
          for (var h = l + 1; h < s; ++h) {
            var p, v = a[l],
              g = a[h];
            (p = u[v])[c = o(p, g)] !== g && p.splice(c, 0, g), (p = u[g])[c =
              o(p, v)] !== v && p.splice(c, 0, v)
          }
      return u
    },
    m = function() {
      ...
      function t(n, t) {
        for (;;) {
          var r = t + 1 << 1,
            ...
            u = t,
            f = e[u];
          if (i < o && l(e[i], f) < 0 && (f = e[u = i]), r < o && l(e[r], f) <
            0 && (f = e[u = r]), u === t) break;
      ...
      return r.push = function(t) {
        ...
        var i, u = r._;
        if (e[u] === r) return u !== --o && (i = e[o], (l(i, r) < 0 ? n : t)
          (e[i._ = u] = i, u)), u
      }, r
    },
    E = function(n, e) {
      ...
      return null == e && (e = c), n.arcs.forEach(function(n) {
        var t, r, c, a, s = [],
          l = 0;
        for (r = 0, c = n.length; r < c; ++r) a = n[r], i(n[r] = [a[0], a[
          1], 1 / 0], r);
        for (r = 1, c = n.length - 1; r < c; ++r) t = n.slice(r - 1, r +
          2), t[1][2] = e(t), s.push(t), f.push(t);
        for (r = 0, c = s.length; r < c; ++r) t = s[r], t.previous = s[r -
          1], t.next = s[r + 1];
        for (; t = f.pop();) {
          var h = t.previous,
            p = t.next;
          t[1][2] < l ? t[1][2] = l : l = t[1][2], h && (h.next = p, h[2] =
            t[2], o(h)), p && (p.previous = h, p[0] = t[0], o(p))
        }
        n.forEach(u)
      }), n
    };
  n.mesh = g, n.meshArcs = f, n.merge = d, n.mergeArcs = s, n.feature = p, n.neighbors =
    y, n.presimplify = E, Object.defineProperty(n, "__esModule", {
      value: !0
    })
});
